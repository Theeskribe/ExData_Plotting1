# Script:  plot1.R
# Project: Exploratory Data Analysis - Course Project 1 - Plot 1
...
# The R code generates a histogram graph  showing the frequency of households'
# Global Active Power in Kilowatts for the dates of 2/1/2007 and 2/2/2007.
# The graph is written to a PNG file (plot1.png) as specified in the Course
# Project description.
